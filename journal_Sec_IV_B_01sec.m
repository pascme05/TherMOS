...
%----------------------------------------
% File based
setup.trFile = ["step_Pv_20W_Ts01secV2"];                                      % list of training files (strings) at least one
setup.teFile = "step_Pv_20W_Ts01secV2";                                       % testing file (string) exactly one
setup.vlFile = ["step_Pv_20W_Ts01secV2"];                                      % list of validation files (strings) at least one
