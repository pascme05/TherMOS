...
%----------------------------------------
% File based
setup.trFile = ["exp113"];                                                  % list of training files (strings) at least one
setup.teFile = "exp113";                                                    % testing file (string) exactly one
setup.vlFile = ["exp113"];                                                  % list of validation files (strings) at least one
