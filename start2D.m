...
%----------------------------------------
% File based
setup.trFile = ["exp331"];                                                   % list of training files (strings) at least one
setup.teFile = "exp331";                                                     % testing file (string) exactly one
setup.vlFile = ["exp331"];                                                   % list of validation files (strings) at least one
