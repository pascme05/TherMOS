...
%----------------------------------------
% File based
setup.trFile = ["exp13"];                                                   % list of training files (strings) at least one
setup.teFile = "exp13";                                                     % testing file (string) exactly one
setup.vlFile = ["exp13"];                                                   % list of validation files (strings) at least one
