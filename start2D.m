...
%----------------------------------------
% File based
setup.trFile = ["exp33_1"];                                                   % list of training files (strings) at least one
setup.teFile = "exp33_1";                                                     % testing file (string) exactly one
setup.vlFile = ["exp33_1"];                                                   % list of validation files (strings) at least one
