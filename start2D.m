...
%----------------------------------------
% File based
setup.trFile = ["exp31"];                                                  % list of training files (strings) at least one
setup.teFile = "exp31";                                                    % testing file (string) exactly one
setup.vlFile = ["exp31"];                                                  % list of validation files (strings) at least one
