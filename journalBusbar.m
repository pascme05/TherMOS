...
%----------------------------------------
% File based
setup.trFile = ["journal132"];                                                % list of training files (strings) at least one
setup.teFile = "journal132";                                                  % testing file (string) exactly one
setup.vlFile = ["journal132"];                                                % list of validation files (strings) at least one
