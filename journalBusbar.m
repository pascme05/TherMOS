...
setup.name = "journalBusbar";                                               % name of the simulation (string)
...
%----------------------------------------
% File based
setup.trFile = ["journal141"];                                                % list of training files (strings) at least one
setup.teFile = "journal141";                                                  % testing file (string) exactly one
setup.vlFile = ["journal141"];                                                % list of validation files (strings) at least one
