...
%----------------------------------------
% File based
setup.trFile = ["journal13"];                                                % list of training files (strings) at least one
setup.teFile = "journal13";                                                  % testing file (string) exactly one
setup.vlFile = ["journal13"];                                                % list of validation files (strings) at least one
