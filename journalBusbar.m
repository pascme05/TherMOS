...
%----------------------------------------
% File based
setup.trFile = ["journal122"];                                                % list of training files (strings) at least one
setup.teFile = "journal122";                                                  % testing file (string) exactly one
setup.vlFile = ["journal122"];                                                % list of validation files (strings) at least one
