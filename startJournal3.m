...
setup.name = "journal3";                                                    % name of the simulation (string)
...
% Configuration
%----------------------------------------
setup.config = "journal3";                                                  % name of the config file (string)
...
%----------------------------------------
% File based
setup.trFile = ["journal36"];                                                % list of training files (strings) at least one
setup.teFile = "journal36";                                                  % testing file (string) exactly one
setup.vlFile = ["journal36"];                                                % list of validation files (strings) at least one
