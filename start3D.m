...
%----------------------------------------
% File based
setup.trFile = ["test3D"];                                                  % list of training files (strings) at least one
setup.teFile = "test3D";                                                    % testing file (string) exactly one
setup.vlFile = ["test3D"];                                                  % list of validation files (strings) at least one
