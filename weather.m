...
% Configuration
%----------------------------------------
setup.config = "weather";                                                   % name of the config file (string)
...
%----------------------------------------
% File based
setup.trFile = ["weather"];                                                 % list of training files (strings) at least one
setup.teFile = "weather";                                                   % testing file (string) exactly one
setup.vlFile = ["weather"];                                                 % list of validation files (strings) at least one

% Sheet based
setup.trSheet = ["train-1", "train-2"];                          % list of training sheets (strings) at least one
...
%----------------------------------------
setup.inp = ["Inp1", "Inp2", "Inp3"];                                             % list of input feature (strings)
setup.out = ["Out1", "Out2"];                                             % list of temperature outputs (strings) 
setup.ref = ["Ref1", "Ref2"];                                             % list of reference temperatures (strings)
