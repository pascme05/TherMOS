...
setup.name = "IMS3D_Total";                                                 % name of the simulation (string)
...
% Configuration
%----------------------------------------
setup.config = "\other\IMS3D_Total";                                        % name of the config file (string)
...
%----------------------------------------
% File based
setup.trFile = ["IMS_10W"];                                                 % list of training files (strings) at least one
setup.teFile = "IMS_20W";                                                   % testing file (string) exactly one
setup.vlFile = ["IMS_10W"];                                                 % list of validation files (strings) at least one
