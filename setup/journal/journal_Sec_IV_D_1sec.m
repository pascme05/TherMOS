...
setup.name = "journal_Sec_IV_D";                                            % name of the simulation (string)
...
% Configuration
%----------------------------------------
setup.config = "\journal\TherMOS_1sec";                                     % name of the config file (string)
...
%----------------------------------------
% File based
setup.trFile = ["step_Pv_5W_Ts1sec"];                                       % list of training files (strings) at least one
setup.teFile = "journal_Seq2";                                              % testing file (string) exactly one
setup.vlFile = ["step_Pv_5W_Ts1sec"];                                       % list of validation files (strings) at least one
