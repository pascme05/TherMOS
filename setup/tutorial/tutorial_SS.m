...
%% Description
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% This tutorial exemplarly shows the usage of SS models based on
...
setup.name = "tutorial_SS";                                                 % name of the simulation (string)
...
% Configuration
%----------------------------------------
setup.config = "\tutorial\tutorial_SS";                                     % name of the config file (string)
