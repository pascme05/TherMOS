...
%% Description
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% This tutorial exemplarly shows the usage of RC models based on
...
setup.name = "tutorial_RC";                                                 % name of the simulation (string)
...
% Configuration
%----------------------------------------
setup.config = "tutorial_1D";                                               % name of the config file (string)
...
%----------------------------------------
setup.inp = ["P_Sec"];                                                      % list of input feature (strings)
setup.out = ["T_Sec"];                                                      % list of temperature outputs (strings) 
