...
%% Description
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% This tutorial exemplarly shows the usage of PO models based on 2D
% temperature fields with different boundary conditions and heat generation
% values
%--------------------------------------------------------------------------
...
setup.name = "tutorial_PO";                                                 % name of the simulation (string)
...
% Configuration
%----------------------------------------
setup.config = "\tutorial\tutorial_PO";                                     % name of the config file (string)
