...
setup.name = "IMS3D";                                                       % name of the simulation (string)
...
% Configuration
%----------------------------------------
setup.config = "\other\IMS3D";                                              % name of the config file (string)
...
%----------------------------------------
% File based
setup.trFile = ["IMS20W"];                                                  % list of training files (strings) at least one
setup.teFile = "IMS20W";                                                    % testing file (string) exactly one
setup.vlFile = ["IMS20W"];                                                  % list of validation files (strings) at least one
