...
%----------------------------------------
% File based
setup.trFile = ["journal1"];                                                % list of training files (strings) at least one
setup.teFile = "journal1";                                                  % testing file (string) exactly one
setup.vlFile = ["journal1"];                                                % list of validation files (strings) at least one
