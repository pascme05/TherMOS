...
%% Description
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% This lecture shows how to use a neural network for temperature prediction
% in electric motors using a simple CNN.
...
setup.name = "lecture_Therm_Opt_1";                                         % name of the simulation (string)
...
% Configuration
%----------------------------------------
setup.config = "\lecture\lecture_Therm_Opt_1";                              % name of the config file (string)
...
%----------------------------------------
setup.inp = ["Ta", "Tc", "Us", "Is", "Tm", "Wm"];                           % list of input feature (strings) "Ta", "Tc", "Us", "Is", "Ss", "Tm", "Wm", "Iw"
setup.out = ["T_sw", "T_rm"];                                               % list of temperature outputs (strings) 
