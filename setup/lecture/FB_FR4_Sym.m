...
% Configuration
%----------------------------------------
setup.config = "\lecture\lecture_TUM_Sym";                                  % name of the config file (string)
...
%----------------------------------------
% File based
setup.trFile = ["FB_FR4_10W"];                                              % list of training files (strings) at least one
setup.teFile = "FB_FR4_20W";                                                % testing file (string) exactly one
setup.vlFile = ["FB_FR4_10W"];                                              % list of validation files (strings) at least one
