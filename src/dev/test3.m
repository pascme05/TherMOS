% Galerkin POD Implementation for Half Aluminum and Half Copper Plate with Constant Temperature Boundaries
...
% ODE function: dTdt = L * T
heat_ode = @(t, T) L * T;

%% 5. Solve the Full-Order Model Using ode45
...
%% 6. Perform Proper Orthogonal Decomposition (POD)
...
%% 7. Construct the Galerkin Reduced-Order Model (ROM)

% Project the Laplacian matrix L onto the reduced basis
L_r = U_r' * L * U_r;

% Define the ODE function for ROM
heat_ode_rom = @(t, a) L_r * a;

%% 8. Solve the ROM Using ode45
...
%% 9. Reconstruct the Full Solution from ROM
...
%% 10. Compute and Plot the Relative L2 Error Over Time
...
%% 11. Visualize the Temperature Distribution at Final Time
