...
%----------------------------------------
% File based
setup.trFile = ["dataRth_Matrix"];                                          % list of training files (strings) at least one
setup.teFile = "dataRth_Matrix";                                            % testing file (string) exactly one
setup.vlFile = ["dataRth_Matrix"];                                          % list of validation files (strings) at least one

% Sheet based
setup.trSheet = ["Load-3", "Load-4", "Load-5", "Load-6"];                                                 % list of training sheets (strings) at least one
setup.teSheet = "Load-4";                                                   % testing sheet (string) exactly one
...
%----------------------------------------
setup.inp = ["Pv1", "Pv2", "Pv3", "Pv4"];                                   % list of input feature (strings)
setup.out = ["T1", "T2", "T3", "T4"];                                       % list of temperature outputs (strings) 
setup.ref = ["Tc1", "Tc2", "Tc3", "Tc4"];                                   % list of reference temperatures (strings)
...
setup.selSF = 1;                                                            % SF-Model (Thermal Strukture Function) 0) de-activated, 1) activated
