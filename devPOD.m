...
%----------------------------------------
% File based
setup.trFile = ["exp14"];                                                   % list of training files (strings) at least one
setup.teFile = "exp14";                                                     % testing file (string) exactly one
setup.vlFile = ["exp14"];                                                   % list of validation files (strings) at least one
