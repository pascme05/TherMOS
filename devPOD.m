...
setup.name = "devPOD";                                                      % name of the simulation (string)
...
% Configuration
%----------------------------------------
setup.config = "devPOD";                                                    % name of the config file (string)
...
%----------------------------------------
% File based
setup.trFile = ["exp112"];                                                   % list of training files (strings) at least one
setup.teFile = "exp112";                                                     % testing file (string) exactly one
setup.vlFile = ["exp112"];                                                   % list of validation files (strings) at least one
